...
- tide level
- land subsidence
- percipitation from neighboring area

## Problem Statement {.flexbox .vcenter}

Can we predict if flooding is going to happen given the weather data and Katulampa flood gate

## Expected Result {.flexbox .vcenter}

To confirm if there is statistical significance that we are able predict the flood before it happens, based on the weather data and percipitation from nearby surrounding area
